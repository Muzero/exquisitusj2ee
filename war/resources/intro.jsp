...
<style type="text/css">
.mybodyclass {
	background: #FFF url(resources/images/icons/bg.gif) repeat-x;
}
</style>
...
<div id="idimg" style="text-align: center; height: 40%; padding-bottom: 16px;">
	<img alt="centrallogo" src="resources/images/icons/logo70.jpg" />
</div>
